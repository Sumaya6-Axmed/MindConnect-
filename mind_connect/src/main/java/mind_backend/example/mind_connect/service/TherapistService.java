...
public class TherapistService {
    ...
    public Therapist updateTherapist(Long id, Therapist therapistDetails) {
        System.out.println("Finding therapist with ID: " + id);
        Therapist therapist = therapistRepository.findById(id)
            .orElseThrow(() -> new RuntimeException("Therapist not found"));

        System.out.println("Found therapist: " + therapist.getFirstName() + " " + therapist.getLastName());
        System.out.println("Updating with data: " + therapistDetails.getFirstName() + " " + therapistDetails.getLastName());
        ...
        System.out.println("Therapist saved successfully with ID: " + savedTherapist.getId());
